...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @atutal.
...
Feel free to submit pull requests on github, or to contact my support group, @atutal, with any bugs, questions \
...
There are two ways of paying him; [PayPal](paypal.me/atutal), or [Monzo](monzo.me/atutal)."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN)
    # else:
    #     update.effective_message.reply_text("naber?")
...
@run_async
def test(bot: Bot, update: Update, keyboard=None):
    if not keyboard:
        keyboard = InlineKeyboardMarkup(paginate_modules(0, HELPABLE, "help"))
    dispatcher.bot.send_message(chat_id=update.effective_chat.id,
                                text="asdasd",
                                parse_mode=ParseMode.MARKDOWN,
                                reply_markup=keyboard)
