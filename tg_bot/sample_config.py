...
class Config(object):
    ...
    OWNER_ID = "1001321863"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "atutal"

    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:postgres@localhost:5432/koindex_tlg_bot'  # needed for any database modules
